		...
		<div class="index-con">
			...
			<div class="container">					
				<div style="width:860px; margin: 30px auto;">
					<form action="<?php echo U('Index/blog_add',array('id'=>$id));?>" method="post">
					  <select name="category_id" id="" class="editselesort">
					      <option value ="">请选择分类</option>
					  	  <option value ="1,5">闲心集</option>
						  <option value ="2,5">前端开发</option>
						  <option value ="3,5">轻微博</option>
						  <option value ="4,5">还没想好</option>
					  </select>
					  <input type="text" name="title" class="edittitle" placeholder="博客标题" style="width:97.5%;" />
					  <textarea id="editor1" name="content" placeholder="博客内容" > 
					  </textarea>
